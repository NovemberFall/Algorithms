...
import static com.williamfiset.algorithms.Graph.treealgorithms.TreeCenter.addUndirectedEdge;
import static com.williamfiset.algorithms.Graph.treealgorithms.TreeCenter.createEmptyTree;
import static com.williamfiset.algorithms.Graph.treealgorithms.TreeCenter.findTreeCenters;
  ...
  public void testTreeCenterVsOtherImpl() {
    for (int n = 1; n < 500; n++) {
      for (int loops = 0; loops < 100; loops++) {
        ...
        List<Integer> impl2 =
            com.williamfiset.algorithms.Graph.treealgorithms.TreeCenterLongestPathImpl

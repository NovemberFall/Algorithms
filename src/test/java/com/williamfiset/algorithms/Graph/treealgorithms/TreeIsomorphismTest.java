...
import static com.williamfiset.algorithms.Graph.treealgorithms.TreeIsomorphism.addUndirectedEdge;
import static com.williamfiset.algorithms.Graph.treealgorithms.TreeIsomorphism.createEmptyGraph;
import static com.williamfiset.algorithms.Graph.treealgorithms.TreeIsomorphism.treesAreIsomorphic;
  ...
  public void testIsomorphismEquivilanceAgainstOtherImpl() {
    for (int n = 1; n < 50; n++) {
      for (int loops = 0; loops < 1000; loops++) {
        ...
        boolean impl2 =
            com.williamfiset.algorithms.Graph.treealgorithms.TreeIsomorphismWithBfs
